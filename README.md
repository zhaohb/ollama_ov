...
## Google Driver
### Windows
[Download exe](https://drive.google.com/file/d/1G9ym_948cVYSPiF9CFxahbVPyMmMgSet/view?usp=sharing) + [Download OpenVINO GenAI](https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2025.2.0.0.dev20250509/openvino_genai_windows_2025.2.0.0.dev20250509_x86_64.zip)
...
| ------------------ | ---------- | ----- | -----------|-------------------- |----------|
| Qwen3-8B-int4-asym-ov                     | 8B      | 4.9GB | INT4_ASYM_128 | [ModelScope](https://modelscope.cn/models/zhaohb/Qwen3-8B-int4-asym-ov)    | CPU, GPU, NPU(base) |
| Qwen3-4B-int4-ov                          | 4B      | 2.7GB | INT4_ASYM_128 | [ModelScope](https://www.modelscope.cn/models/OpenVINO/Qwen3-4B-int4-ov)    | CPU, GPU, NPU(base) |
| Qwen3-1.7B-int4-ov                        | 1.7B    | 1.2GB | INT4_ASYM_128 | [ModelScope](https://www.modelscope.cn/models/OpenVINO/Qwen3-1.7B-int4-ov)    | CPU, GPU, NPU(base) |
| Qwen3-0.6B-int4-ov                        | 0.6B    | 0.5GB | INT4_ASYM_128 | [ModelScope](https://www.modelscope.cn/models/OpenVINO/Qwen3-0.6B-int4-ov)    | CPU, GPU, NPU(base) |
...
4. Unzip OpenVINO GenAI package and set environment
   ```shell
   cd openvino_genai_windows_2025.2.0.0.dev20250509_x86_64
   setupvars.bat
   ```
...
3. Initialize the GenAI environment
   ...
   Download GenAI runtime from [GenAI](https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2025.2.0.0.dev20250509/openvino_genai_windows_2025.2.0.0.dev20250509_x86_64.zip), then extract it to a directory openvino_genai_windows_2025.2.0.0.dev20250509_x86_64 .
   ```shell
   cd openvino_genai_windows_2025.2.0.0.dev20250509_x86_64
   setupvars.bat
   ```
...
3. Initialize the GenAI environment
   ...
   Download GenAI runtime from [GenAI](https://storage.openvinotoolkit.org/repositories/openvino_genai/packages/nightly/2025.2.0.0.dev20250509/openvino_genai_ubuntu22_2025.2.0.0.dev20250509_x86_64.tar.gz), then extract it to a directory openvino_genai_ubuntu22_2025.2.0.0.dev20250509_x86_64.
   ```shell
   cd openvino_genai_ubuntu22_2025.2.0.0.dev20250509_x86_64 
   source setupvars.sh
   ```
